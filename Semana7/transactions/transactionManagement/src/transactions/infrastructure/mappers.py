...
class TransactionMapper(Mapper):
    ...
    def dto_to_entity(self, dto: TransactionDTO) -> TransactionDTO:
        transaction = Transaction(id=dto.id, dni_landlord=dto.dni_landlord, dni_tenant=dto.dni_tenant, 
                                  id_property=dto.id_property, monetary_value=dto.monetary_value, 
                                  contract_initial_date=dto.contract_initial_date, 
                                  contract_final_date=dto.contract_final_date, created_at=dto.createdAt)
        return transaction
