...
def import_alchemy_models():
    import src.properties.infrastructure.dto

def register_handlers():
    import src.properties.application
...
def config_app():
    ...
    host = env.get("DB_HOST", "properties")
    port = env.get("DB_PORT", "5432")
    db_name = env.get("DB_NAME", "properties")
    ...
    from src.api.properties import properties_bp
