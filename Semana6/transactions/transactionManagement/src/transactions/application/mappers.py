...
class MapperTransaction(RepoMap):
    ...
    def entity_to_dto(self, entity: Transaction) -> TransactionAppDTO:
        return TransactionAppDTO(entity.dni_landlord,entity.dni_tenant,entity.id_property,entity.monetary_value,entity.type_lease,entity.contract_initial_date,entity.contract_final_date)
