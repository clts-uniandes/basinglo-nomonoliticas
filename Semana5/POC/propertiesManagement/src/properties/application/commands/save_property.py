...
from src.properties.application.dto import PropertyAppDTO
...
from src.properties.application.mappers import MapperProperty
from src.properties.infrastructure.repositories import PropertyRepository
